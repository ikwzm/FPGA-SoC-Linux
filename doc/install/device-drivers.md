...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i dtbocfg-4.19.57-armv7-fpga_0.0.7-1_armhf.deb
Selecting previously unselected package dtbocfg-4.19.57-armv7-fpga.
(Reading database ... 94204 files and directories currently installed.)
Preparing to unpack dtbocfg-4.19.57-armv7-fpga_0.0.7-1_armhf.deb ...
Unpacking dtbocfg-4.19.57-armv7-fpga (0.0.7-1) ...
Setting up dtbocfg-4.19.57-armv7-fpga (0.0.7-1) ...
```
