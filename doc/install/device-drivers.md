...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i dtbocfg-4.14.34-armv7-fpga_0.0.6-1_armhf.deb
...
Preparing to unpack dtbocfg-4.14.34-armv7-fpga_0.0.6-1_armhf.deb ...
Unpacking dtbocfg-4.14.34-armv7-fpga (0.0.6-1) ...
Setting up dtbocfg-4.14.34-armv7-fpga (0.0.6-1) ...
```
...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i fclkcfg-4.14.34-armv7-fpga_1.1.0-1_armhf.deb
...
Preparing to unpack fclkcfg-4.14.34-armv7-fpga_1.1.0-1_armhf.deb ...
Unpacking fclkcfg-4.14.34-armv7-fpga (1.1.0-1) ...
Setting up fclkcfg-4.14.34-armv7-fpga (1.1.0-1) ...
```
...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i udmabuf-4.14.34-armv7-fpga_1.2.3-1_armhf.deb
...
Preparing to unpack udmabuf-4.14.34-armv7-fpga_1.2.3-1_armhf.deb ...
Unpacking udmabuf-4.14.34-armv7-fpga (1.2.3-1) ...
Setting up udmabuf-4.14.34-armv7-fpga (1.2.3-1) ...
```
