...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i fclkcfg-4.19.57-armv7-fpga_1.1.0-1_armhf.deb
...
Preparing to unpack fclkcfg-4.19.57-armv7-fpga_1.1.0-1_armhf.deb ...
Unpacking fclkcfg-4.19.57-armv7-fpga (1.1.0-1) ...
Setting up fclkcfg-4.19.57-armv7-fpga (1.1.0-1) ...
```
