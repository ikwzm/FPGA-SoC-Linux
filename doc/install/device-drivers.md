...
```console
fpga@debian-fpga:~$ cd /home/fpga/debian
fpga@debian-fpga:~/debian$ sudo dpkg -i dtbocfg-4.14.123-armv7-fpga_0.0.8-1_armhf.deb
...
Preparing to unpack dtbocfg-4.14.123-armv7-fpga_0.0.8-1_armhf.deb ...
Unpacking dtbocfg-4.14.123-armv7-fpga (0.0.8-1) ...
Setting up dtbocfg-4.14.123-armv7-fpga (0.0.8-1) ...
```
