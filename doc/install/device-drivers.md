...
fpga@debian-fpga:~/debian$ sudo dpkg -i linux-image-4.14.21-armv7-fpga_4.14.21-armv7-fpga-1_armhf.deb
(Reading database ... 61992 files and directories currently installed.)
Preparing to unpack linux-image-4.14.21-armv7-fpga_4.14.21-armv7-fpga-1_armhf.deb ...
Unpacking linux-image-4.14.21-armv7-fpga (4.14.21-armv7-fpga-1) ...
Setting up linux-image-4.14.21-armv7-fpga (4.14.21-armv7-fpga-1) ...
```
