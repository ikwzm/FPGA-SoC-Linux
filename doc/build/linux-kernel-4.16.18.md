...
```console
shell$ cp arch/arm/boot/zImage            ../target/zynq-zybo/boot/zImage-4.16.18-armv7-fpga
...
```console
shell$ cp arch/arm/boot/zImage               ../target/zynq-zybo-z7/boot/zImage-4.16.18-armv7-fpga
...
```console
shell$ cp arch/arm/boot/zImage              ../target/zynq-pynqz1/boot/zImage-4.16.18-armv7-fpga
...
```console
shell$ cp arch/arm/boot/zImage                              ../target/de0-nano-soc/boot/zImage-4.16.18-armv7-fpga
...
```console
shell$ cp arch/arm/boot/zImage                              ../target/de10-nano/boot/zImage-4.16.18-armv7-fpga
