...
shell$ sudo cp linux-image-5.10.109-armv7-fpga_5.10.109-armv7-fpga-0_armhf.deb $PWD/$targetdir
````
...
debian11-rootfs# dpkg -i linux-image-5.10.109-armv7-fpga_5.10.109-armv7-fpga-0_armhf.deb
```
...
shell$ sudo rm -f  $PWD/$targetdir/linux-image-5.10.109-armv7-fpga_5.10.109-armv7-fpga-0_armhf.deb
