...
CURRENT_DIR=`pwd`
LINUX_BUILD_DIR=linux-4.14.34-armv7-fpga

### Download Linux Kernel Source
git clone git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git $LINUX_BUILD_DIR
cd $LINUX_BUILD_DIR
git checkout -b linux-4.14.34-armv7-fpga refs/tags/v4.14.34

### Patch for armv7-fpga
patch -p1 < ../files/linux-4.14.34-armv7-fpga.diff
git add --update
...
patch -p1 < ../files/linux-4.14.34-armv7-fpga-patch-usb-chipidea.diff
git add --update
