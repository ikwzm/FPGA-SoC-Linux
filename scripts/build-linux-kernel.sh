...
cp arch/arm/boot/zImage            ../target/zynq-zybo/boot/vmlinuz-4.4.7-armv7-fpga
cp arch/arm/boot/dts/zynq-zybo.dtb ../target/zynq-zybo/boot/zynq-zybo.dtb

### Copy zImage and devicetree to de0-nano-soc/boot/
cp arch/arm/boot/zImage                              ../target/de0-nano-soc/boot/vmlinuz-4.4.7-armv7-fpga
cp arch/arm/boot/dts/socfpga_cyclone5_de0_sockit.dtb ../target/de0-nano-soc/boot/socfpga.dtb
